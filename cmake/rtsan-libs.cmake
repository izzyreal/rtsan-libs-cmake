function(rtsan_libs_enable)
    ...
    elseif(UNIX)
        ...
        set(_type STATIC)
    elseif(WIN32)
        set(_asset "clang_rt.rtsan-x86_64.lib")
        set(_sha "ebcf40e01be3e2575a4416b1945fb8dd757adcbaea325fa2f45869f4d39d0785")
        set(_type STATIC)
    else()
    ...
    if (WIN32)
        set(_lib_url "https://github.com/izzyreal/rtsan-libs/releases/download/v20.1.1.2/${_asset}")
    else()
